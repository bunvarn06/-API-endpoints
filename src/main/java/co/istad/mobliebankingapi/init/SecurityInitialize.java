...
import co.istad.mobliebankingapi.domain.User;
import co.istad.mobliebankingapi.repository.RoleRepository;
import co.istad.mobliebankingapi.repository.UserRepository;
...
public class SecurityInitialize {
    ...
    void init(){
        if (roleRepository.count() == 0) {
            ...
            admin.setPassword(passwordEncoder.encode("koko@123"));
            ...
            staff.setPassword(passwordEncoder.encode("koko@123"));
            staff.setIsEnabled(true);
            staff.setRoles(Set.of(roleUser, roleStaff));

            User customer = new User();
            customer.setUsername("customer");
            customer.setPassword(passwordEncoder.encode("koko@123"));
